...
public class MainActivity extends AppCompatActivity {
    ...
    private void makeGithubSearchQuery() {
        ...
        // Uses AsyncTask
        /// (currently deprecated though. But still pretty cool)
        GithubQueryTask gitQuery = new GithubQueryTask();
//        String queryResult = gitQuery.doInBackground(githubSearchUrl);
//        gitQuery.onPostExecute(queryResult);
        gitQuery.execute(githubSearchUrl);

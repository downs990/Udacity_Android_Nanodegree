...
//      TODO (7) Replace the single TextView with Views to display all of the weather info
        ...
        forecastAdapterViewHolder.weatherForecast.setText(description);
        forecastAdapterViewHolder.weatherHigh.setText(Double.toString(highInCelsius));
        forecastAdapterViewHolder.weatherLow.setText(Double.toString(lowInCelsius));
...
//      TODO (5) Add an ImageView for the weather icon
        ...
        final TextView weatherForecast;
...
//          TODO (6) Get references to all new views and delete this line
            weatherDate = (TextView) view.findViewById(R.id.date_tv);
            weatherForecast = (TextView) view.findViewById(R.id.forecast_tv);
            weatherHigh = (TextView) view.findViewById(R.id.high_tv);
            weatherLow = (TextView) view.findViewById(R.id.low_tv);
            weatherIcon = (ImageView) view.findViewById(R.id.weather_iv);
